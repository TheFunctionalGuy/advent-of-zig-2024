...
read> ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
Enter day number (1-25) or `all` for all days:
> all
Now downloading `https://adventofcode.com/2024/day/1/input` to `src/day_01/input`
[...]
Now downloading `https://adventofcode.com/2024/day/25/input` to `src/day_25/input`
...
[... and so on for days 02-25 ...]
run-day_25                   Run day_25 executable
benchmark-day_25             Benchmark day_25 executable with hyperfine
```
