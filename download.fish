...
echo "Enter day number (1-25) or `all` for all days:"
...
set numbers (seq 1 25)

if test $day_input != all
    if contains $day_input (seq 1 25)
        set numbers $day_input
    else
        echo "Not a valid day (1-25) or `all`"
...
for i in $numbers
    ...
    set download_url "https://adventofcode.com/2024/day/$i/input"
